...
def BPloop(f, list_obs, n_iter, tol, print_it, iter_space, tol2, it_max, init, damp, edge_list):
    # Initialization
    ...
    return mess_list, e_list, it_list, logL_list, err_list
                    ...
                    for i_M, M in enumerate(obs_table):
                        for sim in range(n_sim):
                            ...
                            for _ in range(N_pop):
                                ...
                                edge_list.append((idx, list(G.neighbors(idx))[np.random.randint(0,3)]))
