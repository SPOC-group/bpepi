    ...
    for filename in os.listdir(load_dir):
        ...
        if not os.path.isdir(path):
            if not filename.startswith('.'):
                if (( (print_it == True) and (filename.startswith('IT_'))) or ( (print_it == False) and not (filename.startswith('DF_')) ) ) and flag<100:
                    flag = flag + 1
                    with lzma.open(load_dir + filename, "rb") as f:
                        data = pickle.load(f)
                        [graph, 
                        ...
                        for i, B_list in enumerate(B_tab):
                            ...
                            for it_idx, B in enumerate(B_list):                        
                                ...
                                keys = [
                                    ...
                                    r"$\text{MO}_{t=0,RND}$",
                                    r"$\delta \text{O}_{t=0}$",
                                    r"$\widetilde{\text{O}}_{t=0}$",
                                    r"$\widetilde{\text{MO}}_{t=0}$",
                                    r"$\widetilde{\delta \text{O}}_{t=0}$",
                                    r"$\text{O}_{t=T}$",
                                    r"$\text{O}_{t=T,RND}$",
                                    r"$\text{MO}_{t=T}$",
                                    r"$\text{MO}_{t=T,RND}$",
                                    r"$\delta \text{O}_{t=T}$",
                                    r"$\widetilde{\text{O}}_{t=T}$",
                                    r"$\widetilde{\text{MO}}_{t=T}$",
                                    r"$\widetilde{\delta \text{O}}_{t=T}$",
                                    r"SE",
                                    r"MSE",
                                    r"$\text{SE}_{RND}$",
                                    r"$\text{MSE}_{RND}$",
